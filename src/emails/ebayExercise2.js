				...
				<tbody>
					...
					<tr>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" class="x_mobile-full-width" style="border: none; border-collapse: collapse !important; border-spacing: 0px !important;">
							<tbody>
								<tr>
									<td align="center" bgcolor="#0079bc" class="x_center x_cta-button x_primary-cta-button" style="word-wrap: break-word;" valign="top"><a href="https://www.ebay-support.com.mailru382.co/support" style="text-decoration: none; color: rgb(255, 255, 255); font-size: 18px; font-weight: bold; font-family: Helvetica, Arial, sans-serif;" target="_blank"><span style="padding: 10px 17px;">Protect your account</span></a></td>
								</tr>
							</tbody>
						</table>
						</td>
