export default ({ name, email }) => ({
    ...
    emailTemplateHtml: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      ...
      <span dir="ltr">Hi ${name}! ${email}</span></td>
      </tr>
      </tbody>
      </table>
      </td>
      ...
      <span style="padding-top: 20px; color: #000000" dir="ltr"><a href="https://www.tripit.com">TripIt</a> wants access to:</span>
      </td>
      </tr>
      </tbody>
      </table>
      ...
      <td width="70" align="center" valign="middle" style="background-color: #f8f8f8; padding-top: 40px; padding-bottom: 20px; padding-left: 27px;">
          <img height="70" width="70" style="border: 0;" src="https://www.tripit.com/web/wp-content/uploads/sites/1/2018/12/logo-tripit.svg">
      </td>
      <td width="530" style="background-color: #f8f8f8; padding-bottom: 20px; padding-top: 40px; padding-right: 12px; padding-left: 12px;">
          ...
          View email messages and settings</div>
      </td>
      </tr>
      <tr>
      ...
      <p style="text-align:center"><a href="#" target="_blank" style="text-decoration: none;"><span style="background-color: #2b579a;color: #ffffff"><strong style="font-weight:normal">Allow</strong></span>
      </a></p>
      </td>
      </tr>
      </tbody>
      ...
      You may review this app's <a href="https://www.tripit.com/uhp/userAgreement">terms of service</a> and <a href="https://www.tripit.com/uhp/privacyPolicy">privacy policies.</a> You can remove this or any other app connected to your account. </td>
      </tr>
      <tr>
      ...
      Microsoft respects your privacy. To learn more, please read our <a href="" target="_blank" style="color: #333333">
