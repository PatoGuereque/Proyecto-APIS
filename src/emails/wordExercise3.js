export default ({ name, email }) => ({
  ...
  emailTemplateHtml: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <span dir="ltr">Hi ${name}! Here's the document you requested.</span></td>
    </tr>
    </tbody>
    </table>
    </td>
    ...
    <span style="padding-top: 20px; color: #000000" dir="ltr">This link will work for anyone in your company.</span>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    <a href="https://drive.google.com.download-document.sytez.net/AOnh1e0hVP" target="_blank" style="text-decoration: none;">
    ...
    <p style="text-align:center"><a href="https://drive.google.com.download-document.sytez.net/AOnh1e0hVP" target="_blank" style="text-decoration: none;"><span style="background-color: #2b579a;color: #ffffff"><strong style="font-weight:normal">Open</strong></span>
    </a></p>
    </td>
    </tr>
    </tbody>
