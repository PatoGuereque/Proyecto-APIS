...
<body>
<div class="_rp_25" style="position: relative; margin-bottom: 9px; font-family: wf_segoe-ui_normal, &quot;Segoe UI&quot;, &quot;Segoe WP&quot;, Tahoma, Arial, sans-serif; background-color: rgb(255, 255, 255);">
<div class="_rp_35 ms-font-color-neutralPrimary ms-font-xl ms-fwt-r" style="color: rgb(51, 51, 51); font-size: 21px; overflow: hidden; word-wrap: break-word;">
<div class="allowTextSelection" style="-webkit-user-select: text; cursor: auto;"><span autoid="_rp_B" class="rpHighlightAllClass rpHighlightSubjectClass" role="heading" style="outline: none;" tabindex="0">Help us protect your account</span></div>
</div>
</div>
...
<div class="_rp_85" style="min-height: 70px; min-width: 200px; width: 924px; overflow: hidden; margin-bottom: 4px;">
<div class="_rp_i1" style="position: relative;">
<div>
<div>
<div class="_rp_f2 ms-font-s" role="heading" style="color: rgb(51, 51, 51); font-size: 12px; margin: 7px 0px -2px; padding: 0px;" tabindex="0">
<div class="_db_H customScrollBar scrollContainer" style="overflow-x: hidden; overflow-y: auto; width: 924px; height: auto !important;">
<div class="_db_n ms-bg-color-neutralLight _db_q" style="position: relative; min-height: 30px; margin-top: 10px; margin-bottom: 10px; display: flex; background-color: rgb(241, 249, 242);">
<div>
<div class="_db_i _db_l" style="width: 5px; min-height: 30px; position: absolute; top: 0px; bottom: 0px; background-color: rgb(86, 166, 89);">&nbsp;</div>
</div>

<div class="_db_m" style="position: relative; float: left; align-self: center; margin-left: 20px; padding-top: 5px; padding-bottom: 5px; padding-right: 7px; width: 897px;">
<div class="ms-font-weight-regular ms-font-s InfobarImmediateTextContainer ms-font-color-neutralDark" style="color: rgb(33, 33, 33);">This message is from a trusted sender.</div>
</div>
</div>
</div>
</div>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="border: none; border-collapse: collapse !important; border-spacing: 0px !important; background-color: rgb(249, 249, 249);" width="100%">
	<tbody>
		<tr>
			...
			<table align="center" bgcolor="#f9f9f9" border="0" cellpadding="0" cellspacing="0" class="x_device-width x_header-logo" style="border: none; border-collapse: collapse !important; border-spacing: 0px !important;" width="600">
				<tbody>
					<tr>
						<td style="word-wrap: break-word; padding: 0px; border: none; border-collapse: collapse !important; border-spacing: 0px !important;" valign="top">
						<p align="left" style="font-family: Helvetica, Arial, sans-serif; font-size: 11px; margin: 5px 0px 10px; color: rgb(51, 51, 51);">Is your personal info up to date, ${name}?</p>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<tbody>
					<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" style="margin: 20px 0px;" width="100%">
							<tbody>
								<tr>
									<td style="word-wrap: break-word;" width="50"><img alt="Protect your account" border="0" height="55" src="http://p.ebaystatic.com/aw/register/fyp911_notifications_lock_144_v3.png" style="outline: none; border: none; display: block !important;" width="40" /></td>
									<td style="word-wrap: break-word; border: none; border-collapse: collapse !important; border-spacing: 0px !important;" valign="middle">
									<h2 align="left" style="font-family: Helvetica, Arial, sans-serif; font-weight: normal; line-height: 24px; color: rgb(51, 51, 51); margin: 20px 0px;">Get a higher level of protection</h2>
									</td>
								</tr>
							</tbody>
						</table>
					...
					<tr>
						<td style="word-wrap: break-word; font-family: Helvetica, Arial, sans-serif; color: rgb(51, 51, 51); font-size: 18px; line-height: 24px; border: none; padding: 0px 0px 25px; border-collapse: collapse !important; border-spacing: 0px !important;" valign="top">Hello ${name},</td>
					</tr>
					<tr>
						...
						<p>We are letting you know of recent suspicious activity involving your eBay account. Please can you login to your account and confirm 3 recent purchases.</p>
						</td>
					</tr>
					<tr>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" class="x_mobile-full-width" style="border: none; border-collapse: collapse !important; border-spacing: 0px !important;">
							<tbody>
								<tr>
									<td align="center" bgcolor="#0079bc" class="x_center x_cta-button x_primary-cta-button" style="word-wrap: break-word;" valign="top"><a href="#" style="text-decoration: none; color: rgb(255, 255, 255); font-size: 18px; font-weight: bold; font-family: Helvetica, Arial, sans-serif;" target="_blank"><span style="padding: 10px 17px;">Protect your account</span></a></td>
								</tr>
							</tbody>
						</table>
						</td>
